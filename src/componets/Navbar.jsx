...
function Navbar() {
  const { likedImages, downloadedImages, user, setUser } = useGlobalContext();
  ...
  const handleLogout = async () => {
    try {
      await signOut(auth); // Firebase sign out funksiyasi
      setUser(null); // Global kontekstda foydalanuvchini tozalash
    } catch (error) {
